...
const ICONS = {
  ...
  'Trip Started': [Truck, 'var(--purple-soft)', 'var(--purple)'],
  'Driver Near Destination': [MapPin, 'var(--purple-soft)', 'var(--purple)'],
...
export default function CustomerNotifications() {
  ...
  const load = () => api.get('/customer/notifications').then(({ data }) => setRows(data))
  useEffect(() => { load() }, [])
  const markAll = async () => { await api.put('/customer/notifications/read-all'); load() }
    ...
    <div className="page">
      <div className="page-head">
        <div>
          ...
          <div className="page-sub">Updates on your loads and payments.</div>
        </div>
