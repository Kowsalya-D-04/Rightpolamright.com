...
def register_customer(payload: CustomerRegister, db: Session = Depends(get_db)):
    ...
    customer = Customer(
        ...
        company=payload.company, customer_type=payload.customer_type or "Individual", phone=payload.phone.strip(), email=email,
...
def register_driver(payload: DriverRegister, db: Session = Depends(get_db)):
    ...
    driver = Driver(
        ...
        photo_url=payload.driver_image_url, license_image_url=payload.license_image_url,
    ...
    truck = Truck(
        ...
        model=payload.truck_model, color=payload.truck_color, truck_image_url=payload.truck_image_url,
        rc_image_url=payload.rc_image_url, insurance_image_url=payload.insurance_image_url,
